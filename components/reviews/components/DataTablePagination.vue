  ...
  <div class="flex items-center justify-between px-2">
    ...
    <div class="flex items-center space-x-6 lg:space-x-8">
      ...
      <div class="w-[100px] flex items-center justify-center text-sm font-medium">
        {{ table.getState().pagination.pageIndex + 1 }} бет
      </div>
      <div class="flex items-center space-x-2">
        <Button
            variant="outline"
        ...
        >
          <span class="sr-only">Бірінші бетке өту</span>
        ...
        >
          <span class="sr-only">Алдыңғы бетке өту</span>
        ...
        >
          <span class="sr-only">Келесі бетке өту</span>
        ...
        >
          <span class="sr-only">Соңғы бетке өту</span>
